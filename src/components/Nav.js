      ...
      <div className="nav-wrap">
        <div className="nav-left-wrap">
          <Link style={{ display: 'flex', alignItems: 'center' }} to="/">
            {/* Your SVG image code here */}
            <svg xmlns="http://www.w3.org/2000/svg" width="87" height="32" viewBox="0 0 87 32" fill="none">
  <g clip-path="url(#clip0_718_2087)">
    ...
    <path d="M61.1866 15.4331C61.6005 15.6111 62.129 16.0869 62.338 16.5048C59.8017 19.4838 56.8803 22.227 54.344 22.227C51.8077 22.227 50.9513 20.1127 52.2502 17.8164L58.4168 7.02973H61.4857L54.9053 18.6191C54.1965 19.8397 54.5816 20.3155 55.2577 20.3155C56.6139 20.3155 58.7692 18.2591 60.9818 15.669L61.1866 15.429V15.4331ZM61.8668 1.84949C62.8707 1.84949 63.6655 2.65218 63.6655 3.66588C63.6655 4.67959 62.8707 5.45332 61.8668 5.45332C60.8629 5.45332 60.0967 4.67959 60.0967 3.66588C60.0967 2.65218 60.8629 1.84949 61.8668 1.84949Z" fill="#FD7E14"/>
    ...
    <clipPath id="clip0_718_2087">
      <rect width="87" height="32" fill="white"/>
        ...
        <div>
          ...
          />
             {/* 로그인 버튼 */}
             <Link to="/login" className="nav__login-button">
            로그인
          </Link>
          <Link to="/Mypage" style={{ position: 'relative', top: '5px', right: '5px' }}>
            {/* Your avatar SVG */}
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M12 6C13.1 6 14 6.9 14 8C14 9.1 13.1 10 12 10C10.9 10 10 9.1 10 8C10 6.9 10.9 6 12 6ZM12 16C14.7 16 17.8 17.29 18 18H6C6.23 17.28 9.31 16 12 16ZM12 4C9.79 4 8 5.79 8 8C8 10.21 9.79 12 12 12C14.21 12 16 10.21 16 8C16 5.79 14.21 4 12 4ZM12 14C9.33 14 4 15.34 4 18V20H20V18C20 15.34 14.67 14 12 14Z" fill="#ADB5BD"/>
</svg>
          </Link>
        </div>
      </div>
